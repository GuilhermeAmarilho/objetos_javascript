function Conta(valor=500){
  if(valor<500){
    throw e = "saldo inicial invalido";
  }
  this.saldo=valor;
  this.historico=[];
  this.historico.push("abertura: +" +valor);
  this.sacar=function(valor){
    if ((valor>5)&&(valor<=this.saldo)) {
      this.saldo-=valor;
  ...
  this.depositarDinheiro=function(valor){
    if (valor<=1000) {
      this.saldo+=valor;
      this.historico.push("deposito dinheiro: +"+valor);
      return true;
    }
    else{
      return false;
  ...
  this.depositarCheque=function(valor){
    if (valor<=10000) {
      this.saldo+=valor;
      this.historico.push("deposito cheque: +"+valor);
      return true;
    }
    else{
      return false;
